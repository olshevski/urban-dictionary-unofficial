...
class GetRandomWords(private val definitionsRepository: DefinitionsRepository) :
    GetPagingDataInteractor<Definition>() {

    override fun getPager(): Pager<Int, Definition> = definitionsRepository.getRandomWords()
